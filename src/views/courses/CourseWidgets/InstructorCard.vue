      ...
      >	
         <a href="#" class="instructor-card">
            ...
            <div class="instructor-details">
               <span class="desig d-block fs-12">{{instruct.profile}}, {{instruct.place}}</span>
               <span class="name font-weight-bold d-block">{{instruct.name}}</span>
            </div>
            <div class="instructor-counts">
               <span class="course-count d-block fs-12">{{instruct.courses}} courses</span>
               <span class="student-count d-block fs-12"><span class="font-weight-bold">{{instruct.number}}</span> {{instruct.type}}</span>
            </div>
         </a>
      </app-card>
   </div>
