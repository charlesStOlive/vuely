...
export default {
  ...
  data() {
    return {
      ...
      totalEarnings: [30, 50, 25, 55, 44, 60, 30, 40, 50, 45, 60, 75],
      onlineRevenue: [30, 50, 25, 55, 44, 60, 30, 40, 60, 100, 90, 110],
      newCustomers: [30, 50, 25, 55, 44, 60, 30, 40, 50, 80, 100, 130]
    };
  }
};
</script>
